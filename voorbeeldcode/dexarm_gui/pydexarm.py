#Python driver for Dexarm robot
#Class Dexarm with methods
# n each method, G-code is generated

#load support for USB and regular expressions
...
class Dexarm:
    ...
    def fast_move_to(self, x=None, y=None, z=None, feedrate=2000, wait=True):
        ...
        """
        # changed original move_to into self.move_to because error 
